...
Replace `v1.1.2` with the release tag you intend to deploy. Prefer tagged releases over arbitrary branch tips. For example, an installation on **v1.1.1** can update to **v1.1.2** by checking out that tag after backup.
